package com.tnsif.streamapiprog;
...
//		ob.forEach(System.out::println);
		...
		Integer[] value= new Integer[] {1,2,3,4,4,5};
		Stream<Integer> streamobj = Arrays.stream(value);
		
		System.out.println("skip 1st 2 elemensts");
		Arrays.stream(value).skip(2).forEach(System.out::println);
